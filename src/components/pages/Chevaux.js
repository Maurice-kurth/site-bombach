  ...
  return (
    <>
      ...
      <ContentSection title="Types de pensions" paragraph=" ">
        <ul>
          <li>
            Pension box : litière de paille, granulés le matin et foin matin et
            soir.
          </li>
          <li>Paddocks à disposition. Libre utilisation des installations.</li>
          <li>
            Pension stabulation hiver et pré l’été. En stabulation : litière de
            paille, granulés le matin et foin matin et soir. Au pré : foin en
            libre-service et granulés le matin.
          </li>
